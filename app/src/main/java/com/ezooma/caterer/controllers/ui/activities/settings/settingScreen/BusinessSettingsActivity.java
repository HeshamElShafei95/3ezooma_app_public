...
public class BusinessSettingsActivity extends AppCompatActivity {
    ...
    AppCompatEditText mEdtBusinessName ,mEdtAddress,mEdtMinPersons,mEdtDeliveryDays;
    AppCompatTextView mTxtClosingTimings ,mTxtOpenTimings ;
    @Override
    ...
    private void initVariables() {
        ...
        mEdtMinPersons = findViewById(R.id.edtMinPersons);
        mEdtDeliveryDays = findViewById(R.id.edtDeliveryDays);
        mTxtClosingTimings = findViewById(R.id.txtClosingTimings);
